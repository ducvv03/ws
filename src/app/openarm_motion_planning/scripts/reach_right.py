...
class MoveArm(Node):
    ...
    def send_goal(self):
        ...
        # -0.0057326
        # Nhập tọa độ XYZ
        target.position.x = 0.37724
        target.position.y = -0.15115
        target.position.z = 0.571

        # Nhập góc xoay
        target.orientation.w = -0.016981
        target.orientation.x = 0.6646
        target.orientation.y = 0.14217
        target.orientation.z = 0.73335
