...
colcon build --packages-select head_hardware openarm_description openarm_bringup
...
| `openarm_bringup/launch/openarm.bimanual.launch.py` | declares and passes the head args into xacro |
