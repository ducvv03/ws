...
NB_MODULE(openarm_can, m) {
    ...
    nb::enum_<MotorStatus>(m, "MotorStatus")
        .value("DISABLED", MotorStatus::DISABLED)
        .value("ENABLED", MotorStatus::ENABLED)
        .value("OVERVOLTAGE", MotorStatus::OVERVOLTAGE)
        .value("UNDERVOLTAGE", MotorStatus::UNDERVOLTAGE)
        .value("OVERCURRENT", MotorStatus::OVERCURRENT)
        .value("MOS_OVERTEMPERATURE", MotorStatus::MOS_OVERTEMPERATURE)
        .value("COIL_OVERTEMPERATURE", MotorStatus::COIL_OVERTEMPERATURE)
        .value("COMMUNICATION_LOST", MotorStatus::COMMUNICATION_LOST)
        .value("OVERLOAD", MotorStatus::OVERLOAD)
        .value("UNKNOWN", MotorStatus::UNKNOWN)
        .export_values();

    m.def("motor_status_to_string", &motor_status_to_string, nb::arg("status"));
    m.def("is_fault_status", &is_fault_status, nb::arg("status"));
    ...
    nb::class_<StateResult>(m, "MotorStateResult")
        ...
        .def_rw("raw_status_byte", &StateResult::raw_status_byte);
    ...
    nb::class_<Motor>(m, "Motor")
        ...
        .def("get_raw_status_byte", &Motor::get_raw_status_byte)
        .def("has_fault", &Motor::has_fault)
        .def("get_last_fault", &Motor::get_last_fault)
        .def("clear_last_fault", &Motor::clear_last_fault)
        .def("has_received_state", &Motor::has_received_state)
        .def("get_state_recv_count", &Motor::get_state_recv_count)
        .def("get_time_since_last_state_s", &Motor::get_time_since_last_state_s)
        .def("is_state_stale", &Motor::is_state_stale,
             nb::arg("timeout_s") = DEFAULT_STATE_TIMEOUT_S)
