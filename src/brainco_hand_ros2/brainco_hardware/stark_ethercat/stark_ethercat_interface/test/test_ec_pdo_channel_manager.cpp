...
#include "stark_ethercat_interface/ec_pdo_channel_manager.hpp"
...
TEST(TestEcPdoChannelManager, LoadFromConfig)
{
  ...
  stark_ethercat_interface::EcPdoChannelManager pdo_manager;
  pdo_manager.pdo_type = stark_ethercat_interface::PdoType::RPDO;
