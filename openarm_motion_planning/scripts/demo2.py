...
class MoveDualArmIK(Node):
    ...
    def start_process(self):
        ...
        # self.left_targets = [
        #     create_pose(0.27, 0.10, 0.40, 0.965926, 0.0, 0.258819, 0.0),
        #     create_pose(0.27, 0.05, 0.40, 0.965926, 0.0, 0.258819, 0.0),
        #     create_pose(0.30, 0.10, 0.40, 0.965926, 0.0, 0.258819, 0.0),
        #     # create_pose(0.33, 0.20, 0.50, 0.965926, 0.0, 0.258819, 0.0),
        #     create_pose(0.25, 0.20, 0.35, 0.965926, 0.0, 0.258819, 0.0),
        #     create_pose(0.25, 0.25, 0.35, 0.965926, 0.0, 0.258819, 0.0),
        #     create_pose(-3.4694e-18, 0.1535, 0.222, 1.0, 0.0, 0.0, 0.0),
        # ]
        #
        # self.right_targets = [
        #     create_pose(0.27, -0.20, 0.40, 0.965926, 0.0, 0.258819, 0.0),
        #     create_pose(0.27, -0.15, 0.40, 0.965926, 0.0, 0.258819, 0.0),
        #     create_pose(0.30, -0.10, 0.40, 0.965926, 0.0, 0.258819, 0.0),
        #     # create_pose(0.33, -0.0, 0.50, 0.965926, 0.0, 0.258819, 0.0),
        #     create_pose(0.25, -0.0, 0.35, 0.965926, 0.0, 0.258819, 0.0),
        #     create_pose(0.25, -0.05, 0.35, 0.965926, 0.0, 0.258819, 0.0),
        #     create_pose(-3.4694e-18, -0.1535, 0.222, 1.0, 0.0, 0.0, 0.0),
        # ]
    ...
    def move_next_target(self):
        ...
        self.target_left = self.left_targets[self.current_index]
        self.target_right = self.right_targets[self.current_index]

        self.get_logger().info(
            "==============================\n"
            f"Moving to target {self.current_index + 1}\n"
            "=============================="
        )
        ...
        self.compute_ik(
            ...
            "openarm_left_tcp",
            self.target_left,
            self.on_left_ik_done
        )
# -47 10 -2 48 -83 15 -6 87 -10 -90 28 -21 2 4
    # ============================================================
    # IK CALLBACKS
    # ============================================================
